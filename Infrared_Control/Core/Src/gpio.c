...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIO1_GPIO_Port, GPIO1_Pin);

  /**/
  LL_GPIO_ResetOutputPin(CSB_GPIO_Port, CSB_Pin);

  /**/
  LL_GPIO_ResetOutputPin(SCK_GPIO_Port, SCK_Pin);

  /**/
  LL_GPIO_ResetOutputPin(SDIO_GPIO_Port, SDIO_Pin);

  /**/
  LL_GPIO_ResetOutputPin(FCSB_GPIO_Port, FCSB_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(CSB_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SDIO_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(FCSB_GPIO_Port, &GPIO_InitStruct);
