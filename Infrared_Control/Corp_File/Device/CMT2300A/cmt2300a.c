...
/*! ********************************************************
* @name    CMT2300A_SetPktType
* @desc    Set PKT_TYPE Fixed or Variable.
* @param   nLength
* *********************************************************/
void CMT2300A_SetPktType(uint8_t u8PktType)
{ 
    u8 tmp = CMT2300A_ReadReg(CMT2300A_CUS_PKT14);
    
    tmp |= u8PktType & CMT2300A_MASK_PKT_TYPE;
    CMT2300A_WriteReg(CMT2300A_CUS_PKT14, tmp);
}
